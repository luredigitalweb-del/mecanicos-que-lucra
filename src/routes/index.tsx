...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Aulão ao vivo de 3 dias para donos de oficina mecânica. Aprenda o passo a passo para fazer sua oficina lucrar mais. Entre na lista de espera." },
