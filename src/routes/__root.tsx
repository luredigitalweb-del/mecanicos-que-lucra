...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Aulão ao vivo de 3 dias para donos de oficina mecânica e centros automotivos. Aprenda o passo a passo para fazer sua oficina lucrar mais. Apenas R$ 47,00." },
      ...
      { property: "og:description", content: "Aulão ao vivo de 3 dias para donos de oficina mecânica e centros automotivos. Aprenda o passo a passo para fazer sua oficina lucrar mais. Apenas R$ 47,00." },
      ...
      { name: "twitter:description", content: "Aulão ao vivo de 3 dias para donos de oficina mecânica e centros automotivos. Aprenda o passo a passo para fazer sua oficina lucrar mais. Apenas R$ 47,00." },
