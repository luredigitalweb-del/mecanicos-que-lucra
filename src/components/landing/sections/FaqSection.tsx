...
const faqs = [
  ...
  },
  {
    ...
    answer: "Você tem 7 dias de garantia incondicional. Se assistir o aulão e achar que não valeu os R$ 19,90, devolvemos 100% do seu dinheiro. Basta enviar um e-mail — sem perguntas, sem burocracia.",
  },
  {
